package tk.alltrue.tipcalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SeekBar percentageSeekBar = (SeekBar) findViewById(R.id.percentSeekBar);
        percentageSeekBar.setOnSeekBarChangeListener(seekBarChangeListener);
    }
